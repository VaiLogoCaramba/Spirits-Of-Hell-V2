...
function turnOn()
    if ye then 
        ...
        for i = 0,7 do 
            noteTweenY('notesMove'..i, i, defY, fastieY, 'quadOut')
        end
    else 
        ye = true 
        ...
        for i = 0,7 do 
            noteTweenY('notesMove'..i, i, downscroll and defY-60 or defY+60, fastieY, 'quadOut')
        end
    end
end

function onEvent(tag, v1, v2)
    if tag == 'sonicBarsNotesH' then
        turnOn()
